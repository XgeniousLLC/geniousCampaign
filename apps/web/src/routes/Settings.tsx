...
const TABS = ['Members', 'Audit log', 'Suppression list', 'Custom fields', 'AI usage', 'API keys', 'Integrations'] as const;
  ...
  return (
    <div>
      ...
      <div className="mb-[18px] flex gap-5 border-b border-border-default">
        {TABS.filter((t) => (t !== 'Integrations' && t !== 'AI usage' && t !== 'API keys') || isOwner).map((t) => (
          <button
            key={t}
            onClick={() => setTab(t)}
